...
public class TestFreeMarker {
	...
	public void testFreemarker() throws Exception {
		...
		//3.设置模板所在的路径
		configuration.setDirectoryForTemplateLoading(new File("E:/Workspaces/taotao/taotao-item-web/src/main/webapp/WEB-INF/ftl"));
		//4.设置模板的字符集，一般utf-8
...
//		Template template = configuration.getTemplate("hello.ftl");
		...
		Writer out = new FileWriter(new File("D:/temp/javaee/out/student.html"));
